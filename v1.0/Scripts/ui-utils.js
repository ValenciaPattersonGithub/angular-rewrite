      ...
      compile: function uiMaskCompilingFunction(){
        ...
        return function uiMaskLinkingFunction(scope, iElement, iAttrs, controller){
          ...
          // Vars for initializing/uninitializing
            originalPlaceholder = iAttrs.maskPlaceholder,
          ...
          iAttrs.$observe('maskPlaceholder', initPlaceholder);
          ...
          function uninitialize(){
            ...
            if (angular.isDefined(originalPlaceholder)) {
              iElement.attr('mask-placeholder', originalPlaceholder);
            } else {
              iElement.removeAttr('mask-placeholder');
            }
          ...
          function initializeElement(){
            ...
            iElement.attr('mask-placeholder', maskPlaceholder);
          ...
          function bindEventListeners(){
            ...
            iElement.bind('input keyup keydown click focus', eventHandler);
            eventsBound = true;
          }
          ...
          function unbindEventListeners(){
            ...
            iElement.unbind('keydown', eventHandler);
          ...
          function getPlaceholderChar(i) {
            var placeholder = iAttrs.maskPlaceholder;
          ...
          function eventHandler(e){
            ...
            // Case: Typing a character to overwrite a selection
              isAddition = (val.length > valOld.length) || (!isKeyLeftArrow && selectionLenOld && val.length > valOld.length - selectionLenOld),
            ...
            if (isSelection || (isSelected && (eventType === 'click' || eventType === 'keyup' || eventType === 'keydown'))) {
              return;
            }
          ...
          function setCaretPosition(input, pos){
            ...
            if (input.setSelectionRange) {
              var currentScroll = angular.element(document).scrollTop();
              var currentFocus = document.activeElement;
              // fixing ie 11 scrolling bug
