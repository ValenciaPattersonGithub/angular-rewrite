describe('patientServiceTile directive ->', function () {
  ...
  beforeEach(function () {
    element = angular.element(
      '<patient-service-tile patientService="patientService" tileIndex="tileIndex" showDate="showDate"></patient-service-tile>'
    );
  ...
  it('should scope to be defined', function () {
    ...
    expect(scope.patientService).not.toBeNull();
