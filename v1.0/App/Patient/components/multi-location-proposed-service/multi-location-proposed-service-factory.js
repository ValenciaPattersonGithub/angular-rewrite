(function () {
  ...
  MultiLocationProposedServiceFactory.$inject = [
    'ListHelper',
    'PatientOdontogramFactory',
    'referenceDataService',
  ];

  function MultiLocationProposedServiceFactory(
    listHelper,
    patientOdontogramFactory,
    referenceDataService
  ) {
     ...
     * @param {*} currentServiceCode
     * @returns {angular.IPromise<string>} Next smart code
     */
