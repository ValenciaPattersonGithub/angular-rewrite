...
angular
  ...
  .directive('appointmentViewEndTimeDropdown', function () {
    return {
      restrict: 'E',
      scope: {
        //selectedStartTime: '=',
      ...
      templateUrl:
        'App/Schedule/appointments/appointment-view/appointment-view-end-time-dropdown.html',
      controller: 'AppointmentViewEndTimeDropdownController',
