...
describe('CommunicationCenterPreviewpaneComponent', () => {
    let component: CommunicationCenterPreviewpaneComponent;
    let fixture: ComponentFixture<CommunicationCenterPreviewpaneComponent>;
    ...
    const mockRichTextSanitizerService: any = {
    ...
    const mockreferenceDataService = {
        get: (a: any) => { },
        entityNames: {
            users: [{ UserId: '12', FirstName: 'FN', LastName: 'LN' }] // 'users'
        }
    };
    ...
    configureTestSuite(() => {
        TestBed.configureTestingModule({
            ...
            providers: [DialogService, DialogContainerService, HttpClient, ReferralManagementHttpService,
                ...
                { provide: RichTextSanitizerService, useValue: mockRichTextSanitizerService },
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(CommunicationCenterPreviewpaneComponent);
    ...
    describe('openConfirmationModal', () => {
        it('should call deleteCommunicationSuccess when patientCommunicationService.deletePatientCommunicationById return success', () => {
            ...
            component.openConfirmationModal(mockCommunicationConstants.deleteConfirmationModalData, patientCommunicationId);
