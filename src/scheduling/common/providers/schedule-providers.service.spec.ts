...
import { ScheduleProvidersService } from './schedule-providers.service';


describe('ScheduleProvidersService', () => {
    let service: ScheduleProvidersService;
    ...
    const mockScheduleProvidersService = new ScheduleProvidersService();
    mockScheduleProvidersService.providers = mockProviders;

    beforeEach(() => {
        TestBed.configureTestingModule({
            providers: [
                { provide: ScheduleProvidersService, useValue: mockScheduleProvidersService }
            ]
        });
        service = TestBed.get(ScheduleProvidersService);
    });
    ...
    it('findByUserId should return null when providers list is null or undefined', () => {
        let localService = new ScheduleProvidersService();
        localService.providers = null;
