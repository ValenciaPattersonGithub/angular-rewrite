import { ClaimDto, ServiceTransactionToClaimPaymentDto } from 'src/@core/models/bulk-payment/bulk-insurance-dtos.model';
import { InsurancePaymentIsValidPipe } from './insurance-payment-is-valid.pipe';

describe('InsurancePaymentIsValidPipe', () => { 
    let claimsList: ClaimDto[];
    ...
    it('create an instance', () => {
       const pipe = new InsurancePaymentIsValidPipe();
    ...
    describe('when canEditAllowedAmount parameter is true', () => {
        it('should return true when payment exceeds the AllowedAmount if AllowedAmount is 0 and OriginalAllowedAmount is 0 if not FeeSchedule item', () => {      
            ...
            claimsList[0].PaymentAmount = 50;
            claimsList[0].ServiceTransactionToClaimPaymentDtos[0].FeeScheduleGroupDetailId = null;
            claimsList[0].ServiceTransactionToClaimPaymentDtos[0].PaymentAmount = 50.00;
            claimsList[0].ServiceTransactionToClaimPaymentDtos[0].AllowedAmount = 0;
        ...
        it('should return false when payment exceeds the AllowedAmount if AllowedAmount does not equal OriginalAllowedAmount if not FeeSchedule item', () => {      
            const pipe = new InsurancePaymentIsValidPipe();
            claimsList[0].PaymentAmount = 50;
            claimsList[0].ServiceTransactionToClaimPaymentDtos[0].FeeScheduleGroupDetailId = null;
            claimsList[0].ServiceTransactionToClaimPaymentDtos[0].PaymentAmount = 50.00;
            claimsList[0].ServiceTransactionToClaimPaymentDtos[0].AllowedAmount = 10;
            claimsList[0].ServiceTransactionToClaimPaymentDtos[0].OriginalAllowedAmount = 0;
            claimsList[0].ServiceTransactionToClaimPaymentDtos[0].PaymentAmount = 11.0;
            claimsList[0].ServiceTransactionToClaimPaymentDtos[0].Charges = 11.00;
            claimsList[0].ServiceTransactionToClaimPaymentDtos[0].TotalInsurancePayments = 0;
