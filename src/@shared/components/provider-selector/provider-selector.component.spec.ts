...
describe('ProviderSelectorComponent', () => {
    ...
    var mockPreferredProvidersList = [
        { 'ProviderId': 'd46e2bb2-f3f9-41de-b2bd-1a1f7a84438e', 'UserId': 'd46e2bb2-f3f9-41de-b2bd-1a1f7a84438e', Name: 'Bob Jones', IsPreferred: false, UserLocationSetup: { LocationId: 2, ProviderTypeId: 1 } },
        { 'ProviderId': '43189973-d808-4fd1-a8cc-fabf84c9f18f', 'UserId': '43189973-d808-4fd1-a8cc-fabf84c9f18f', Name: 'Sid Jones', IsPreferred: false, UserLocationSetup: { LocationId: 2, ProviderTypeId: 1 } },
        { 'ProviderId': 'ab796156-f6f9-4057-a463-4d4c23a74dca', 'UserId': 'ab796156-f6f9-4057-a463-4d4c23a74dca', Name: 'Larry Jones', IsPreferred: false, UserLocationSetup: { LocationId: 2, ProviderTypeId: 3 } },
        { 'ProviderId': 'eedf5827-6735-4832-9d20-99758df70a8b', 'UserId': 'eedf5827-6735-4832-9d20-99758df70a8b', Name: 'Pat Jones', IsPreferred: false, UserLocationSetup: { LocationId: 2, ProviderTypeId: 1 } },
        { 'ProviderId': '517ce215-b71b-408f-8b20-62a4c1386f77', 'UserId': '517ce215-b71b-408f-8b20-62a4c1386f77', Name: 'Sylvia Jones', IsPreferred: false, UserLocationSetup: { LocationId: 2, ProviderTypeId: 2 } },
    ];
    ...
    beforeEach(function () {
        for (let index = 0; index < mockProviderList.length; index++) {
            ...
            var userLocationSetup = {
                UserId: mockProviderList[index].UserId, IsActive: true, LocationId: 1, ProviderTypeId: 1,
                ProviderOnClaimsRelationship: 1, ProviderOnClaimsId: null, Color: '#7f7f7f', ProviderQualifierType: 2
            };
            mockProviderList[index].Locations.push(userLocationSetup);
            if (index in [0, 1, 2, 3, 4, 9, 10]) {
                // add location 2
                userLocationSetup = {
                    UserId: mockProviderList[index].UserId, IsActive: true, LocationId: 2, ProviderTypeId: 2,
                    ProviderOnClaimsRelationship: 1, ProviderOnClaimsId: null, Color: '#7f7f7f', ProviderQualifierType: 1
                };
                mockProviderList[index].Locations.push(userLocationSetup);
            ...
            if (index in [5, 6, 7, 8]) {
                // add location 3
                userLocationSetup = {
                    UserId: mockProviderList[index].UserId, IsActive: true, LocationId: 3, ProviderTypeId: 2,
                    ProviderOnClaimsRelationship: 1, ProviderOnClaimsId: null, Color: '#7f7f7f', ProviderQualifierType: 1
                };
                mockProviderList[index].Locations.push(userLocationSetup);
    ...
    describe('addDynamicColumnsToProviders function ->', function () {
        var allProviderList;
        beforeEach(function () {
            allProviderList = cloneDeep(mockProviderList);
        });
    ...
    describe('loadProvidersByLocation function ->', function ()
    {
        beforeEach(function () {
            ...
            mockShowOnScheduleFactory.getAll = jasmine.createSpy().and.returnValue({ then: function () { } });
        });
        ...
        it('should call addDynamicColumnsToProvider', function () {
            component.loadProvidersByLocation();
            expect(component.addDynamicColumnsToProviders).toHaveBeenCalledWith(mockProviderList);
        });
        ...
        describe('when scope.filterShowOnSchedule is true and ctrl.showOnSchedulePromise is defined ->', function () {
            ...
            beforeEach(function () {
                component.filterShowOnSchedule = true;
                mockShowOnScheduleFactory.getAll = function () { return { then: function () { return promise; } }; };
    ...
    describe('filterProviders function ->', function () {
        var provList = [
            { ProviderId: '1234', UserId: '1234', FirstName: 'Bob', LastName: 'Jones', Name: 'Bob Jones', IsPreferred: false, IsActive: false },
            { ProviderId: '1235', UserId: '1235', FirstName: 'Sid', LastName: 'Jones', Name: 'Sid Jones', IsPreferred: false, IsActive: true },
            { ProviderId: '1236', UserId: '1236', FirstName: 'Larry', LastName: 'Jones', Name: 'Larry Jones', IsPreferred: false, IsActive: true },
            { ProviderId: '1237', UserId: '1237', FirstName: 'Pat', LastName: 'Jones', Name: 'Pat Jones', IsPreferred: false, IsActive: true },
            { ProviderId: '1238', UserId: '1238', FirstName: 'Sylvia', LastName: 'Jones', Name: 'Sylvia Jones', IsPreferred: false, IsActive: true },
        ];
        beforeEach(function () {
            component.filterProviderList = jasmine.createSpy().and.returnValue(provList);
        });
        ...
        it('should set filterByLocationId to currentLocation.id if filterByLocationId is null', function () {
            ...
            expect(component.filterProviderList).toHaveBeenCalledWith(component.allProvidersList, component.currentLocation.id);
        });
        ...
        it('should set filterByLocationId to filterByLocationId if filterByLocationId is not null', function () {
            ...
            component.filterProviders();
            expect(component.filterProviderList).toHaveBeenCalledWith(component.allProvidersList, filterByLocationId);
        });


        it('should set filterByLocationId to multiple locationids when it is set', function () {
            component.filterByLocationId = [1, 2];
            var filterByLocationId = component.filterByLocationId;
            component.filterProviders();
        ...
        it('should set providers and providersLoaded', function () {
            component.providers = null;
            // order the provList 
            var providers = provList.sort((providerA: any, providerB: any) => {
        ...
        it('should not wait on showOnSchedulePromise if it exists and filterShowOnSchedule is false', function () {
            ...
            component.filterProviders();
            expect(component.showOnSchedulePromise.then).not.toHaveBeenCalledWith(component.providers);
        });
        ...
        it('should wait on showOnSchedulePromise if it exists and filterShowOnSchedule is true', function () {
            ...
            component.showOnSchedulePromise = { then: jasmine.createSpy() };
            component.filterProviders();
            expect(component.showOnSchedulePromise.then).toHaveBeenCalledWith(component.providers);
        });
        ...
        it('should order providers by IsActive then Name', function () {
            ...
            component.showOnSchedulePromise = { then: jasmine.createSpy() };
            component.filterProviders();
            expect(component.providers[0].Name).toEqual('Sid Jones');
            expect(component.providers[0].IsActive).toEqual(true);

            expect(component.providers[1].Name).toEqual('Larry Jones');
            expect(component.providers[1].IsActive).toEqual(true);

            expect(component.providers[2].Name).toEqual('Pat Jones');
            expect(component.providers[2].IsActive).toEqual(true);

            expect(component.providers[3].Name).toEqual('Sylvia Jones');
            expect(component.providers[3].IsActive).toEqual(true);

            expect(component.providers[4].Name).toEqual('Bob Jones');
            expect(component.providers[4].IsActive).toEqual(false);
        });
    });
    ...
    describe('ctrl.filterProvidersByUserLocations function ->', function () {
        ...
        it('should filter the providerList to only providers with userLocationSetup records in the filterByLocationId location', function () {
            ...
            var filteredProviderList = component.filterProvidersByUserLocations(allProvidersList, component.filterByLocationId);
            for (let index = 0; index < filteredProviderList.length; index++) {
                expect(filteredProviderList[index].UserId).toEqual(providersWithLocation2[index].UserId);
            }
        });

        it('should filter the providerList to only providers with userLocationSetup records in the filterByLocationId location 2', function () {
            component.currentLocation = { id: 3 };
            var filteredProviderList = component.filterProvidersByUserLocations(allProvidersList, component.filterByLocationId);
            for (let index = 0; index < filteredProviderList.length; index++) {
                expect(filteredProviderList[index]).toEqual(providersWithLocation2[index]);
            }
        });
    ...
    describe('addExceptionProvider function ->', function () {
        ...
        beforeEach(function () {
            ...
            filteredProviderList = component.filterProvidersByUserLocations(component.allProvidersList, [3]);
        });

        it('should not add provider passed as exceptionProviderId to the list even if not in the filteredProviderList ' +
            'and if it is not in the allProvidersList', function () {
                ...
                var providerInAllProvidersList = component.allProvidersList.find((provider) => {
                ...
                var providerInFilteredProviderList = filteredProviderList.find((provider) => {
                    return provider.UserId === component.exceptionProviderId;
                });
        ...
        it('should add provider passed as exceptionProviderId to the list even if not in the filteredProviderList ' +
            ...
            function () {
                ...
                component.currentLocation = { id: 2 };
                var filteredProviderList = component.filterProvidersByUserLocations(
                    component.allProvidersList, component.filterByLocationId
                );
                for (let index = 0; index < filteredProviderList.length; index++) {
                    expect(filteredProviderList[index].UserId).toEqual(providersWithLocation2[index].UserId);
                }
    ...
    describe('filterByProviderType function ->', function () {
        ...
        it('should filter the list by providerTypeIds', function () {
            ...
            filteredProviderList = component.filterByProviderType(filteredProviderList);
    ...
    describe('addOptionsForExaminingDentist function ->', function () {
        it('should add options to the examinedentist when optionsForExaminingDentist exists and not undefined', function () {
            var filteredProviderList = [];
            spyOn(component, 'addOptionsForExaminingDentist').and.callFake(function () { return filteredProviderList; });
        ...
        it('should not add options to the examinedentist when optionsForExaminingDentist not exists ', function () {
            spyOn(component, 'addOptionsForExaminingDentist').and.callFake(function () { });
            var ProviderList = [{
                UserId: '1',
                IsActive: true
            },
    ...
    describe('filterProviderListForOnlyActive function ->', function () {
        ...
        beforeEach(function () {
            ...
            component.selectedProvider = '';
            component.loadProvidersByLocation = jasmine.createSpy();
            filteredProviderList = component.filterProvidersByUserLocations(component.allProvidersList, [2]);
            filteredProviderList.forEach(provider => {
        ...
        it('should filter the providerList for only providers who are active if onlyActive is true ', function () {
            ...
            var filteredList = component.filterProviderListForOnlyActive(filteredProviderList);
    ...
    describe('filterProviderListForShowOnSchedule function ->', function () {
        ...
        it('should return providerList when scope.filterShowOnSchedule is not true', function () {
            component.filterShowOnSchedule = false;
            var returnValue = component.filterProviderListForShowOnSchedule('providerList', false);
        ...
        it('should return correct results when scope.filterShowOnSchedule is true', function () {
            ...
            var result = component.filterProviderListForShowOnSchedule(providers, filterByLocationId);

            expect(result.length).toBe(5);
        });
    });

    describe('sortProviderListForClinicalNotes', () => {
        it('should sort dentist list and other providers list by last name', () => {
            const filteredProviderList = [
                ...
                {
                    UserLocationSetup: [{ provider: { ProviderTypeId: 2 } }],
                    LastName: 'ProviderB',
                },
                {
                    UserLocationSetup: [{ provider: { ProviderTypeId: 3 } }],
                    LastName: 'ProviderA',
                },
            ];

            const sortedList = component.sortProviderListForClinicalNotes(filteredProviderList);

            expect(sortedList[0].LastName).toBe('DentistC');
            expect(sortedList[1].LastName).toBe('ProviderA');
            expect(sortedList[2].LastName).toBe('ProviderB');
        });
    });
    ...
    describe('filterProviderList function ->', function () {
        ...
        beforeEach(function () {
            ...
            component.allProvidersList = cloneDeep(mockProviderList);
            component.currentLocation = { id: 2 };
            spyOn(component, 'filterProvidersByUserLocations').and.callFake(function () { return filteredProviderList; });
            spyOn(component, 'filterProviderListForOnlyActive').and.callFake(function () { return filteredProviderList; });
            spyOn(component, 'filterProviderListForShowOnSchedule').and.returnValue(filteredProviderList);
            spyOn(component, 'setPreferredProviders').and.callFake(function () { return filteredProviderList; });
            spyOn(component, 'addExceptionProvider').and.callFake(function () { return filteredProviderList; });
            spyOn(component, 'defaultSelectedProvider').and.callFake(function () { });

        });

        it('should call filterProvidersByUserLocations ', function () {
            component.filterProviderList(component.allProvidersList, filterByLocationId);
            expect(component.filterProvidersByUserLocations).toHaveBeenCalledWith(component.allProvidersList, component.filterByLocationId);
        });

        it('should call filterProviderListForOnlyActive ', function () {
            component.filterProviderList(component.allProvidersList, filterByLocationId);
            expect(component.filterProviderListForOnlyActive).toHaveBeenCalledWith(filteredProviderList);
        });

        it('should call ctrl.setPreferredProviders ', function () {
            component.filterProviderList(component.allProvidersList, filterByLocationId);
            expect(component.setPreferredProviders).toHaveBeenCalledWith(filteredProviderList, component.filterByLocationId);
        });

        it('should call ctrl.addExceptionProvider ', function () {
            component.filterProviderList(component.allProvidersList, filterByLocationId);
            expect(component.defaultSelectedProvider).toHaveBeenCalledWith(filteredProviderList);
        });

        it('should call ctrl.addExceptionProvider ', function () {
            component.filterProviderList(component.allProvidersList, filterByLocationId);
            expect(component.addExceptionProvider).toHaveBeenCalledWith(filteredProviderList);
        });

    });

    describe('ngOnChanges', () => {
        it('should call filterProviders when patientInfo changes and not first change', () => {
            spyOn(component, 'filterProviders');
            const changes = {
                patientInfo: {
                    currentValue: { PreferredDentist: 2 },
                    firstChange: false,
                },
            };
        ...
        it('should call filterProviders when filterByLocationId or isDisabled changes and component is initialized', () => {
            spyOn(component, 'filterProviders');
        ...
        it('should not call filterProviders when filterByLocationId or isDisabled changes and component is not initialized', () => {
            spyOn(component, 'filterProviders');
            component.initialized = false;
            ...
            component.ngOnChanges(changes);
            expect(component.filterProviders).not.toHaveBeenCalled();
        });
    });

    describe('setPreferredProviders', () => {
        it('should sort provider list by last name when sortForClinicalNotes is true', () => {
            component.sortForClinicalNotes = true;
            const providerList = [
                { UserId: 1, LastName: 'DentistA' },
                { UserId: 2, LastName: 'DentistB' },
                { UserId: 3, LastName: 'DentistC' },
            ];

            const sortedList = component.setPreferredProviders(providerList, []);

            expect(sortedList[0].LastName).toBe('DentistA');
            expect(sortedList[1].LastName).toBe('DentistB');
            expect(sortedList[2].LastName).toBe('DentistC');
        });

        it('should set IsPreferred to true for the preferred dentist when sortForClinicalNotes is false', () => {
            component.sortForClinicalNotes = false;
            const providerList = [
                { UserId: 1, IsPreferred: false },
                { UserId: 2, IsPreferred: false },
                { UserId: 3, IsPreferred: false },
            ];
            component.patientInfo = { PreferredDentist: 2 };

            const updatedList = component.setPreferredProviders(providerList, []);

            expect(updatedList[0].IsPreferred).toBe(false);
            expect(updatedList[1].IsPreferred).toBe(true);
            expect(updatedList[2].IsPreferred).toBe(false);
        });
    });
    ...
    describe('defaultsSelectedProvider function ->', function () {
        ...
        it('should set scope.selectedProvider to either patientInfo.Profile.PreferredDentist' +
            'if scope.setPreferred is true and patientInfo.Profile.PreferredDentist is in list' +
            ' and patient has a preferredProvider and scope.usuallyPerformedBy = 1 has been passed to directive ', function () {
                component.selectedProvider = '';
                ...
                component.patientInfo = { Profile: { PreferredDentist: mockPreferredProvidersList[0].ProviderId } };

                component.defaultSelectedProvider(filteredProviderList);
                jasmine.clock().tick(2);
                expect(component.selectedProvider).toEqual(mockPreferredProvidersList[0].ProviderId);
            });

        it('should set scope.selectedProvider to either patientInfo.Profile.PreferredHygienist' +
            'if scope.setPreferred is true and patientInfo.Profile.PreferredHygienist is in list' +
            ' and patient has a preferredProvider and scope.usuallyPerformedBy = 2 has been passed to directive ', function () {
                component.selectedProvider = '';
                component.setPreferred = true;
                component.usuallyPerformedBy = 2;
                filteredProviderList[0].IsPreferred = true;
                filteredProviderList[0].UserLocationSetup.ProviderTypeId = 3;
                component.patientInfo = { Profile: { PreferredHygienist: mockPreferredProvidersList[0].ProviderId } };
        ...
        it('should set scope.selectedProvider to patientInfo.PreferredDentist' +
            ...
            ' and patient has a preferredProvider and scope.usuallyPerformedBy = 1 has been passed to directive ', function () {
                ...
                filteredProviderList[0].IsPreferred = true;
                filteredProviderList[0].UserLocationSetup.ProviderTypeId = 3;
                component.patientInfo = { PreferredDentist: mockPreferredProvidersList[0].ProviderId };
        ...
        it('should set scope.selectedProvider to patientInfo.PreferredHygienist' +
            ...
            ' and patient has a preferredProvider and scope.usuallyPerformedBy = 2 has been passed to directive ', function () {
                ...
                filteredProviderList[0].IsPreferred = true;
                filteredProviderList[0].UserLocationSetup.ProviderTypeId = 3;
                component.patientInfo = { PreferredHygienist: mockPreferredProvidersList[0].ProviderId };
        ...
        it('should not set scope.selectedProvider to provider who has provider.IsPreferred set to true and ProviderTypeId is not 4' +
        ...
        it('should set scope.selectedProvider to provider who has provider.IsPreferred set to true and ProviderTypeId = 2 ' +
        ...
        it('should not set scope.selectedProvider if selectedProvider is undefined and scope.setPreferred is true and patientInfo is not available' +
            ' ', function () {
                component.selectedProvider = '';
                component.setPreferred = true;
                component.usuallyPerformedBy = 2;
