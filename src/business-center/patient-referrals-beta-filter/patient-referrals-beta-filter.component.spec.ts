...
import { PatientReferralsBetaFilterComponent } from './patient-referrals-beta-filter.component';
...
import { of } from 'rxjs';
describe('PatientReferralsBetaFilterComponent', () => {
    let component: PatientReferralsBetaFilterComponent;
    let fixture: ComponentFixture<PatientReferralsBetaFilterComponent>;
    ...
    const mockSources = [
      ...
      const mockResponse = [
        {
            "practice": {
                "practiceAffiliateId": "00000000-0000-0000-0000-000000000000",
                "practiceId": 26899,
                "name": "",
                "providerAffiliateId": "00000000-0000-0000-0000-000000000000"
            },
            "provider": {
                "address1": "Test",
                "address2": "Add 2 ",
                ...
                "phone": "8888888888",
                "practiceId": 26899,
                "providerAffiliateId": "1c1b2297-dde6-47f6-8ab0-139e6b9d802d",
                "zipCode": "23321",
                "totalRecords": 0
            }
        },
        {
            ...
            "provider": {
                ...
                "phone": "1111111111",
                "practiceId": 26899,
                "providerAffiliateId": "b629a36c-8a5b-4c23-a25a-299dd6f82c94",
                "zipCode": "",
                "totalRecords": 0
            }
        },
        {
            ...
            "provider": {
                ...
                "phone": "1111111111",
                "practiceId": 26899,
                "providerAffiliateId": "889b646e-be87-41e1-8f6a-350eb2883f81",
                "zipCode": "87654",
                "totalRecords": 0
            }
        }
    ...
    const mockReferralManagementHttpService = {
        getSources: jasmine.createSpy().and.returnValue({
            then: function (callback: any) {
                callback(mockSources);
            }
        }),
        getPracticeProvidersForReport: jasmine.createSpy().and.returnValue(
            of(mockResponse)
        )
    };
    ...
    configureTestSuite(() => {
        TestBed.configureTestingModule({
            declarations: [PatientReferralsBetaFilterComponent, HighlightTextIfContainsPipe, ToShortDisplayDateUtcPipe],
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(PatientReferralsBetaFilterComponent);
    ...
    describe('referralSourcesServiceGetSuccess ->', () => {
        it('referralSourcesServiceGetSuccess should be', () => {
            ...
            expect(component.referralSources[0].SourceName).toEqual('All');
        });
    });
    ...
    describe('notifyChange ->', () => {
        it('notifyChange should be called', () => {
            ...
            expect(component.inputReferralFilterModel.totalSelected).toBe(0);
    ...
    const mockPatientReferralTypes_val = [
        { name: 'Category 1', selected: true, value: 'cat1' },
        { name: 'Category 2', selected: false, value: 'cat2' },
        { name: 'All Categories', selected: true, value: 'all' }
      ];
    ...
    describe('ReferralTypeChanged ->', () => {
        ...
        it('ReferralTypeChanged should be called with type empty', () => {
            var type = '';
            component.patientReferralTypeOptions = mockPatientReferralTypes_val;
