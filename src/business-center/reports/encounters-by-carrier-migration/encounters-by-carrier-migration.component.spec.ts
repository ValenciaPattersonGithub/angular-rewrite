...
import { EncountersByCarrierMigrationComponent } from './encounters-by-carrier-migration.component';

describe('EncountersByCarrierMigrationComponent', () => {
  let component: EncountersByCarrierMigrationComponent;
  let fixture: ComponentFixture<EncountersByCarrierMigrationComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ EncountersByCarrierMigrationComponent ]
    })
    .compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(EncountersByCarrierMigrationComponent);
