...
@Component({
  selector: 'payment-location-reconciliation-migration',
  templateUrl: './payment-location-reconciliation-migration.component.html',
  styleUrls: ['./payment-location-reconciliation-migration.component.scss']
})
export class PaymentLocationReconciliationMigrationComponent implements OnInit {
  ofcLocation = '';
