...
@Component({
  selector: 'appointments-transfer',
  templateUrl: './appointments-transfer.component.html',
  styleUrls: ['./appointments-transfer.component.scss'],
})
export class AppointmentsTransferComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.massUpdateService
      .massUpdateCheckForPendingBatchByActivityArea(this.ActivityArea)
  ...
  loadRecentRecords() {
    this.massUpdateService
      .GetRecentPatientAppointmentsMassUpdates(this.ActivityArea)
      .pipe(takeWhile(() => this.alive))
      .subscribe(data => {
  ...
  getFormInfo() {
    ...
    this.massUpdate = {
      ...
      IsUnScheduleAppointment:
        this.massUpdateFormGroup.controls['optIsUnSchedule'].value,
      ...
      ActivityArea:
        this.massUpdateFormGroup.controls['optIsUnSchedule'].value == true
          ? 3
          : 2, // For Patient Transfer Module,
  ...
  loadCurrentRunData() {
    this.massUpdateService
      .getMassUpdateAppointmentInfo(this.massUpdateId)
      .pipe(takeWhile(() => this.alive))
      .subscribe(data => {
            ...
            data => {
              ...
              this.toastrFactory.success(
                this.localize.getLocalizedString(
                  'Mass Appointment Transfer Started'
                ),
                this.localize.getLocalizedString('Success')
              );
            },
  ...
  reset() {
    this.providerTypes = [];
    this.providerTypes = [1, 2, 3, 5];
    this.locationId = 0;
    this.selectedFromProvider = '';
    this.selectedToProvider = '';
    this.donotIncudeInactivePatients = true;
    this.massUpdateFormGroup.controls['optIsUnSchedule'].patchValue(true);
  }
        ...
        this.massUpdateService
          ...
          .subscribe(
            data => {
              ...
              this.toastrFactory.success(
                this.localize.getLocalizedString(
                  'Mass Appointments Transfer Started'
                ),
                this.localize.getLocalizedString('Success')
              );
            },
      ...
      .subscribe(data => {
        ...
        if (this.batchInfo) {
          ...
          var headerText =
            ...
            '\r\n';
          var patientsString = '';
          var failedReason = type == 3 ? ',Block,' : ',';
          var failedReasonColumnName = type == 3 ? ',Reason,' : ',';
          ...
          if (patientsString.length > 0) {
            ...
            let csvArray =
              headerText +
              '\r\n' +
              'First Name,Last Name,Patient Code' +
              failedReasonColumnName +
              'Update On' +
              '\r\n' +
              patientsString;
