...
import { AppointmentsTransferComponent } from './appointments-transfer.component';
...
describe('AppointmentsTransferComponent', () => {
  let component: AppointmentsTransferComponent;
  let fixture: ComponentFixture<AppointmentsTransferComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [AppointmentsTransferComponent, OrderByPipe, SearchPipe],
    }).compileComponents();
  });
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AppointmentsTransferComponent);
